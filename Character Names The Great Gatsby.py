...
characters = OrderedDict([
    ("Nick Carraway", "Carraway house|Carraway|Mr\. Carraway|Nick"), # here the values do not contain regex groups (in parentheses) on purpose --> see explanation at special function
...
def write_to_csv(results):
    ...
    with open ("results_The_Great_Gatsby.csv", "w") as f:
        write = csv.writer(f)
        write.writerow(rows)
...
def main():
    ...
    for key in characters.keys():
        ...
        # speical function for Blocks Biloxi
